...
public class MenuController implements Initializable {
    ...
    public void clickInstructions(MouseEvent event) throws IOException {
        
        Node component = (Node) event.getSource();
         Stage stageLvl = (Stage) component.getScene().getWindow();
        
        FXMLLoader loader = new FXMLLoader(getClass().getResource("InstructionsGUI.fxml"));
        Parent root = loader.load();
    ...
    public void clickAboutUs(MouseEvent event) throws IOException {
    ...
    public void clickLore(MouseEvent event) throws IOException {
        
        Node component = (Node) event.getSource();
         Stage stageLvl = (Stage) component.getScene().getWindow();
        
        FXMLLoader loader = new FXMLLoader(getClass().getResource("LoreGUI.fxml"));
        Parent root = loader.load();
